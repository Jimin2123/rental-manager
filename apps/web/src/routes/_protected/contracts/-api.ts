...
export const fetchContracts = () => api.get<ContractListItem[]>('/contracts').then((r) => r.data);

export const fetchContract = (id: string) => api.get<ContractDetail>(`/contracts/${id}`).then((r) => r.data);
